-- From https://github.com/manilarome/the-glorious-dotfiles/
...
local filesystem = require('gears.filesystem')
local config_dir = filesystem.get_configuration_dir()
local widget_icon_dir = config_dir .. 'module/icons/'
...
local change_background_on_time = false					-- Dynamic background will only work with `blur` mode

local wall_dir = gears.filesystem.get_configuration_dir() .. 'themes/zenburn/'
local default_wall_name = 'wp.png'
